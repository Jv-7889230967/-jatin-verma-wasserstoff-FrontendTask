...
export default function Home() {
  ...
  return (
    <div className="flex overflow-x-hidden h-screen w-screen bg-orange-100">
      ...
      <div className="flex flex-col h-auto w-auto overflow-x-auto absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        ...
        <section className="flex flex-row h-20 w-auto gap-3 items-center m-2">
        ...
        <section className="flex h-20 w-auto gap-3 items-center m-2">
        ...
        <section className="flex h-20 w-100% gap-3 items-center m-2">
